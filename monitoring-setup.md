...
Go to the latest release on [keryx-stratum-bridge releases](https://github.com/keryx-labs/keryx-stratum-bridge/releases) and download the source code. Download the zip archive for windows, tar.gz for everything else.
